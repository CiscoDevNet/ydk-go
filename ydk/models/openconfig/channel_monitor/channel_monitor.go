...
func (channelMonitors *ChannelMonitors) GetEntityData() *types.CommonEntityData {
    ...
    channelMonitors.EntityData.Children = make(map[string]types.YChild)
    channelMonitors.EntityData.Children["channel-monitor"] = types.YChild{"ChannelMonitor", nil}
    for i := range channelMonitors.ChannelMonitor {
        channelMonitors.EntityData.Children[types.GetSegmentPath(&channelMonitors.ChannelMonitor[i])] = types.YChild{"ChannelMonitor", &channelMonitors.ChannelMonitor[i]}
    }
    channelMonitors.EntityData.Leafs = make(map[string]types.YLeaf)
...
func (channelMonitor *ChannelMonitors_ChannelMonitor) GetEntityData() *types.CommonEntityData {
    ...
    channelMonitor.EntityData.SegmentPath = "channel-monitor" + "[name='" + fmt.Sprintf("%v", channelMonitor.Name) + "']"
    ...
    channelMonitor.EntityData.Children = make(map[string]types.YChild)
    channelMonitor.EntityData.Children["config"] = types.YChild{"Config", &channelMonitor.Config}
    channelMonitor.EntityData.Children["state"] = types.YChild{"State", &channelMonitor.State}
    channelMonitor.EntityData.Children["channels"] = types.YChild{"Channels", &channelMonitor.Channels}
    channelMonitor.EntityData.Leafs = make(map[string]types.YLeaf)
    channelMonitor.EntityData.Leafs["name"] = types.YLeaf{"Name", channelMonitor.Name}
...
func (config *ChannelMonitors_ChannelMonitor_Config) GetEntityData() *types.CommonEntityData {
    ...
    config.EntityData.Leafs["monitor-port"] = types.YLeaf{"MonitorPort", config.MonitorPort}
...
func (state *ChannelMonitors_ChannelMonitor_State) GetEntityData() *types.CommonEntityData {
    ...
    state.EntityData.Leafs["monitor-port"] = types.YLeaf{"MonitorPort", state.MonitorPort}
...
func (channels *ChannelMonitors_ChannelMonitor_Channels) GetEntityData() *types.CommonEntityData {
    ...
    channels.EntityData.Children = make(map[string]types.YChild)
    channels.EntityData.Children["channel"] = types.YChild{"Channel", nil}
    for i := range channels.Channel {
        channels.EntityData.Children[types.GetSegmentPath(&channels.Channel[i])] = types.YChild{"Channel", &channels.Channel[i]}
    }
    channels.EntityData.Leafs = make(map[string]types.YLeaf)
...
func (channel *ChannelMonitors_ChannelMonitor_Channels_Channel) GetEntityData() *types.CommonEntityData {
    ...
    channel.EntityData.SegmentPath = "channel" + "[lower-frequency='" + fmt.Sprintf("%v", channel.LowerFrequency) + "']" + "[upper-frequency='" + fmt.Sprintf("%v", channel.UpperFrequency) + "']"
    ...
    channel.EntityData.Leafs["lower-frequency"] = types.YLeaf{"LowerFrequency", channel.LowerFrequency}
    channel.EntityData.Leafs["upper-frequency"] = types.YLeaf{"UpperFrequency", channel.UpperFrequency}
...
func (state *ChannelMonitors_ChannelMonitor_Channels_Channel_State) GetEntityData() *types.CommonEntityData {
    ...
    state.EntityData.Children = make(map[string]types.YChild)
    state.EntityData.Leafs = make(map[string]types.YLeaf)
    state.EntityData.Leafs["lower-frequency"] = types.YLeaf{"LowerFrequency", state.LowerFrequency}
    state.EntityData.Leafs["upper-frequency"] = types.YLeaf{"UpperFrequency", state.UpperFrequency}
    state.EntityData.Leafs["psd"] = types.YLeaf{"Psd", state.Psd}
    return &(state.EntityData)
}
