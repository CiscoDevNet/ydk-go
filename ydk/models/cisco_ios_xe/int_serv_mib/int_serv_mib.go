...
func (iNTSERVMIB *INTSERVMIB) GetEntityData() *types.CommonEntityData {
    ...
    iNTSERVMIB.EntityData.Children = make(map[string]types.YChild)
    iNTSERVMIB.EntityData.Children["intSrvGenObjects"] = types.YChild{"Intsrvgenobjects", &iNTSERVMIB.Intsrvgenobjects}
    iNTSERVMIB.EntityData.Children["intSrvIfAttribTable"] = types.YChild{"Intsrvifattribtable", &iNTSERVMIB.Intsrvifattribtable}
    iNTSERVMIB.EntityData.Children["intSrvFlowTable"] = types.YChild{"Intsrvflowtable", &iNTSERVMIB.Intsrvflowtable}
    iNTSERVMIB.EntityData.Leafs = make(map[string]types.YLeaf)
