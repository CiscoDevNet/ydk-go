...
func (instagt *Instagt) GetEntityData() *types.CommonEntityData {
    ...
    instagt.EntityData.AbsolutePath = instagt.EntityData.SegmentPath
...
func (trace *Instagt_Trace) GetEntityData() *types.CommonEntityData {
    ...
    trace.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-show-trace-instagt:instagt/" + trace.EntityData.SegmentPath
...
func (location *Instagt_Trace_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-show-trace-instagt:instagt/trace/" + location.EntityData.SegmentPath
...
func (allOptions *Instagt_Trace_Location_AllOptions) GetEntityData() *types.CommonEntityData {
    ...
    allOptions.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-show-trace-instagt:instagt/trace/location/" + allOptions.EntityData.SegmentPath
...
func (traceBlocks *Instagt_Trace_Location_AllOptions_TraceBlocks) GetEntityData() *types.CommonEntityData {
    ...
    traceBlocks.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-show-trace-instagt:instagt/trace/location/all-options/" + traceBlocks.EntityData.SegmentPath
