...
// All rights reserved.
package sysadmin_hw_module_xrv9k
...
func init() {
    ydk.YLogDebug(fmt.Sprintf("Registering top level entities for package sysadmin_hw_module_xrv9k"))
    ydk.RegisterEntity("{http://www.cisco.com/ns/yang/Cisco-IOS-XR-sysadmin-hw-module-xrv9k hw-module}", reflect.TypeOf(HwModule{}))
    ydk.RegisterEntity("Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module", reflect.TypeOf(HwModule{}))
}
...
func (hwModule *HwModule) GetEntityData() *types.CommonEntityData {
    ...
    hwModule.EntityData.ParentYangName = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k"
    hwModule.EntityData.SegmentPath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module"
...
func (config *HwModule_Config) GetEntityData() *types.CommonEntityData {
    ...
    config.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/" + config.EntityData.SegmentPath
...
func (shutdown *HwModule_Config_Shutdown) GetEntityData() *types.CommonEntityData {
    ...
    shutdown.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/" + shutdown.EntityData.SegmentPath
...
func (location *HwModule_Config_Shutdown_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/shutdown/" + location.EntityData.SegmentPath
...
func (reset *HwModule_Config_Reset) GetEntityData() *types.CommonEntityData {
    ...
    reset.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/" + reset.EntityData.SegmentPath
...
func (auto *HwModule_Config_Reset_Auto) GetEntityData() *types.CommonEntityData {
    ...
    auto.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/reset/" + auto.EntityData.SegmentPath
...
func (disable *HwModule_Config_Reset_Auto_Disable) GetEntityData() *types.CommonEntityData {
    ...
    disable.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/reset/auto/" + disable.EntityData.SegmentPath
...
func (location *HwModule_Config_Reset_Auto_Disable_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.SegmentPath = "location" + types.AddKeyToken(location.Location, "location")
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/reset/auto/disable/" + location.EntityData.SegmentPath
    location.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    location.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    location.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (offline *HwModule_Config_Offline) GetEntityData() *types.CommonEntityData {
    ...
    offline.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/" + offline.EntityData.SegmentPath
...
func (location *HwModule_Config_Offline_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.SegmentPath = "location" + types.AddKeyToken(location.Location, "location")
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/offline/" + location.EntityData.SegmentPath
    location.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    location.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    location.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (location *HwModule_Config_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.SegmentPath = "location" + types.AddKeyToken(location.Location, "location")
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/" + location.EntityData.SegmentPath
    location.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    location.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    location.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (logging *HwModule_Config_Location_Logging) GetEntityData() *types.CommonEntityData {
    ...
    logging.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/location/" + logging.EntityData.SegmentPath
...
func (onboard *HwModule_Config_Location_Logging_Onboard) GetEntityData() *types.CommonEntityData {
    ...
    onboard.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/config/location/logging/" + onboard.EntityData.SegmentPath
...
func (oper *HwModule_Oper) GetEntityData() *types.CommonEntityData {
    ...
    oper.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/" + oper.EntityData.SegmentPath
...
func (location *HwModule_Oper_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.SegmentPath = "location" + types.AddKeyToken(location.Location, "location")
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/oper/" + location.EntityData.SegmentPath
    location.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    location.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    location.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (actions *HwModule_Oper_Location_Actions) GetEntityData() *types.CommonEntityData {
    ...
    actions.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/oper/location/" + actions.EntityData.SegmentPath
...
func (cbootmedia *HwModule_Oper_Location_Actions_Cbootmedia) GetEntityData() *types.CommonEntityData {
    ...
    cbootmedia.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/oper/location/actions/" + cbootmedia.EntityData.SegmentPath
...
func (bootmedia *HwModule_Oper_Location_Actions_Cbootmedia_Bootmedia) GetEntityData() *types.CommonEntityData {
    ...
    bootmedia.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/oper/location/actions/cbootmedia/" + bootmedia.EntityData.SegmentPath
...
func (show *HwModule_Oper_Location_Show) GetEntityData() *types.CommonEntityData {
    ...
    show.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/oper/location/" + show.EntityData.SegmentPath
...
func (shhwfpd *HwModule_Shhwfpd) GetEntityData() *types.CommonEntityData {
    ...
    shhwfpd.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/" + shhwfpd.EntityData.SegmentPath
...
func (alocation *HwModule_Shhwfpd_Alocation) GetEntityData() *types.CommonEntityData {
    ...
    alocation.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/shhwfpd/" + alocation.EntityData.SegmentPath
...
func (fpd *HwModule_Shhwfpd_Alocation_Fpd) GetEntityData() *types.CommonEntityData {
    ...
    fpd.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/shhwfpd/alocation/" + fpd.EntityData.SegmentPath
...
func (fpd *HwModule_Shhwfpd_Fpd) GetEntityData() *types.CommonEntityData {
    ...
    fpd.EntityData.SegmentPath = "fpd" + types.AddKeyToken(fpd.Fpdname, "fpdname")
    fpd.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-hw-module-xrv9k:hw-module/shhwfpd/" + fpd.EntityData.SegmentPath
    fpd.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fpd.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fpd.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
