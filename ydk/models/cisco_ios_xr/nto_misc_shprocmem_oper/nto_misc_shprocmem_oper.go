...
func (nodes *ProcessesMemory_Nodes) GetEntityData() *types.CommonEntityData {
    ...
    nodes.EntityData.AbsolutePath = "Cisco-IOS-XR-nto-misc-shprocmem-oper:processes-memory/" + nodes.EntityData.SegmentPath
...
func (node *ProcessesMemory_Nodes_Node) GetEntityData() *types.CommonEntityData {
    ...
    node.EntityData.AbsolutePath = "Cisco-IOS-XR-nto-misc-shprocmem-oper:processes-memory/nodes/" + node.EntityData.SegmentPath
...
func (jobIds *ProcessesMemory_Nodes_Node_JobIds) GetEntityData() *types.CommonEntityData {
    ...
    jobIds.EntityData.AbsolutePath = "Cisco-IOS-XR-nto-misc-shprocmem-oper:processes-memory/nodes/node/" + jobIds.EntityData.SegmentPath
...
func (jobId *ProcessesMemory_Nodes_Node_JobIds_JobId) GetEntityData() *types.CommonEntityData {
    ...
    jobId.EntityData.AbsolutePath = "Cisco-IOS-XR-nto-misc-shprocmem-oper:processes-memory/nodes/node/job-ids/" + jobId.EntityData.SegmentPath
