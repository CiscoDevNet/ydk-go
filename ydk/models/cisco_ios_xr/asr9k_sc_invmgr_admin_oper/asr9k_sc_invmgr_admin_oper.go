...
func (inventory *Inventory) GetEntityData() *types.CommonEntityData {
    ...
    inventory.EntityData.ParentYangName = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper"
    inventory.EntityData.SegmentPath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory"
...
func (racks *Inventory_Racks) GetEntityData() *types.CommonEntityData {
    ...
    racks.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/" + racks.EntityData.SegmentPath
...
func (rack *Inventory_Racks_Rack) GetEntityData() *types.CommonEntityData {
    ...
    rack.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/" + rack.EntityData.SegmentPath
    ...
    rack.EntityData.Children.Append("power-supply-shelfs", types.YChild{"PowerSupplyShelfs", &rack.PowerSupplyShelfs})
    ...
    rack.EntityData.Children.Append("power-supply-zones", types.YChild{"PowerSupplyZones", &rack.PowerSupplyZones})
    rack.EntityData.Children.Append("basic-attributes", types.YChild{"BasicAttributes", &rack.BasicAttributes})
...
func (powerSupplyShelfs *Inventory_Racks_Rack_PowerSupplyShelfs) GetEntityData() *types.CommonEntityData {
    powerSupplyShelfs.EntityData.YFilter = powerSupplyShelfs.YFilter
    powerSupplyShelfs.EntityData.YangName = "power-supply-shelfs"
    powerSupplyShelfs.EntityData.BundleName = "cisco_ios_xr"
    powerSupplyShelfs.EntityData.ParentYangName = "rack"
    powerSupplyShelfs.EntityData.SegmentPath = "power-supply-shelfs"
    powerSupplyShelfs.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/" + powerSupplyShelfs.EntityData.SegmentPath
    powerSupplyShelfs.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    powerSupplyShelfs.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    powerSupplyShelfs.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()

    powerSupplyShelfs.EntityData.Children = types.NewOrderedMap()
    powerSupplyShelfs.EntityData.Children.Append("power-supply-shelf", types.YChild{"PowerSupplyShelf", nil})
    for i := range powerSupplyShelfs.PowerSupplyShelf {
        powerSupplyShelfs.EntityData.Children.Append(types.GetSegmentPath(powerSupplyShelfs.PowerSupplyShelf[i]), types.YChild{"PowerSupplyShelf", powerSupplyShelfs.PowerSupplyShelf[i]})
    }
    powerSupplyShelfs.EntityData.Leafs = types.NewOrderedMap()

    powerSupplyShelfs.EntityData.YListKeys = []string {}

    return &(powerSupplyShelfs.EntityData)
}
...
func (powerSupplyShelf *Inventory_Racks_Rack_PowerSupplyShelfs_PowerSupplyShelf) GetEntityData() *types.CommonEntityData {
    powerSupplyShelf.EntityData.YFilter = powerSupplyShelf.YFilter
    powerSupplyShelf.EntityData.YangName = "power-supply-shelf"
    powerSupplyShelf.EntityData.BundleName = "cisco_ios_xr"
    powerSupplyShelf.EntityData.ParentYangName = "power-supply-shelfs"
    powerSupplyShelf.EntityData.SegmentPath = "power-supply-shelf" + types.AddKeyToken(powerSupplyShelf.Number, "number")
    powerSupplyShelf.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/power-supply-shelfs/" + powerSupplyShelf.EntityData.SegmentPath
    powerSupplyShelf.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    powerSupplyShelf.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    powerSupplyShelf.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()

    powerSupplyShelf.EntityData.Children = types.NewOrderedMap()
    powerSupplyShelf.EntityData.Children.Append("basic-attributes", types.YChild{"BasicAttributes", &powerSupplyShelf.BasicAttributes})
    powerSupplyShelf.EntityData.Leafs = types.NewOrderedMap()
    powerSupplyShelf.EntityData.Leafs.Append("number", types.YLeaf{"Number", powerSupplyShelf.Number})

    powerSupplyShelf.EntityData.YListKeys = []string {"Number"}

    return &(powerSupplyShelf.EntityData)
}
...
func (basicAttributes *Inventory_Racks_Rack_PowerSupplyShelfs_PowerSupplyShelf_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.ParentYangName = "power-supply-shelf"
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/power-supply-shelfs/power-supply-shelf/" + basicAttributes.EntityData.SegmentPath
...
func (basicInfo *Inventory_Racks_Rack_PowerSupplyShelfs_PowerSupplyShelf_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/power-supply-shelfs/power-supply-shelf/basic-attributes/" + basicInfo.EntityData.SegmentPath
...
func (slots *Inventory_Racks_Rack_Slots) GetEntityData() *types.CommonEntityData {
    ...
    slots.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/" + slots.EntityData.SegmentPath
...
func (slot *Inventory_Racks_Rack_Slots_Slot) GetEntityData() *types.CommonEntityData {
    ...
    slot.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/" + slot.EntityData.SegmentPath
...
func (cards *Inventory_Racks_Rack_Slots_Slot_Cards) GetEntityData() *types.CommonEntityData {
    ...
    cards.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/" + cards.EntityData.SegmentPath
...
func (card *Inventory_Racks_Rack_Slots_Slot_Cards_Card) GetEntityData() *types.CommonEntityData {
    ...
    card.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/" + card.EntityData.SegmentPath
...
func (subSlots *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots) GetEntityData() *types.CommonEntityData {
    ...
    subSlots.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/" + subSlots.EntityData.SegmentPath
...
func (subSlot *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot) GetEntityData() *types.CommonEntityData {
    ...
    subSlot.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/" + subSlot.EntityData.SegmentPath
...
func (module *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module) GetEntityData() *types.CommonEntityData {
    ...
    module.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/" + module.EntityData.SegmentPath
...
func (portSlots *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots) GetEntityData() *types.CommonEntityData {
    ...
    portSlots.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/" + portSlots.EntityData.SegmentPath
...
func (portSlot *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot) GetEntityData() *types.CommonEntityData {
    ...
    portSlot.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/" + portSlot.EntityData.SegmentPath
...
func (port *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_Port) GetEntityData() *types.CommonEntityData {
    ...
    port.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/" + port.EntityData.SegmentPath
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_Port_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/port/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_Port_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/port/basic-attributes/" + fruInfo.EntityData.SegmentPath
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_Port_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/port/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_Port_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/port/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_Port_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/port/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_PortSlots_PortSlot_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/port-slots/port-slot/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (sensors *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_Sensors) GetEntityData() *types.CommonEntityData {
    ...
    sensors.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/" + sensors.EntityData.SegmentPath
...
func (sensor *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_Sensors_Sensor) GetEntityData() *types.CommonEntityData {
    ...
    sensor.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/sensors/" + sensor.EntityData.SegmentPath
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_Sensors_Sensor_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/sensors/sensor/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_Sensors_Sensor_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/sensors/sensor/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_Sensors_Sensor_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/sensors/sensor/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_Sensors_Sensor_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/sensors/sensor/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_Sensors_Sensor_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/sensors/sensor/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_Module_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/module/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_SubSlots_SubSlot_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sub-slots/sub-slot/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (hwComponents *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents) GetEntityData() *types.CommonEntityData {
    ...
    hwComponents.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/" + hwComponents.EntityData.SegmentPath
...
func (hwComponent *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent) GetEntityData() *types.CommonEntityData {
    ...
    hwComponent.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/" + hwComponent.EntityData.SegmentPath
...
func (sensors *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_Sensors) GetEntityData() *types.CommonEntityData {
    ...
    sensors.EntityData.SegmentPath = "sensors"
    sensors.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/" + sensors.EntityData.SegmentPath
    sensors.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    sensors.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    sensors.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (sensor *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_Sensors_Sensor) GetEntityData() *types.CommonEntityData {
    ...
    sensor.EntityData.ParentYangName = "sensors"
    sensor.EntityData.SegmentPath = "sensor" + types.AddKeyToken(sensor.Number, "number")
    sensor.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/sensors/" + sensor.EntityData.SegmentPath
    sensor.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    sensor.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    sensor.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_Sensors_Sensor_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.ParentYangName = "sensor"
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/sensors/sensor/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_Sensors_Sensor_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/sensors/sensor/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_Sensors_Sensor_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/sensors/sensor/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_Sensors_Sensor_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/sensors/sensor/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_Sensors_Sensor_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/sensors/sensor/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_HwComponents_HwComponent_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/hw-components/hw-component/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (portSlots *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots) GetEntityData() *types.CommonEntityData {
    ...
    portSlots.EntityData.SegmentPath = "port-slots"
    portSlots.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/" + portSlots.EntityData.SegmentPath
    portSlots.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    portSlots.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    portSlots.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (portSlot *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot) GetEntityData() *types.CommonEntityData {
    ...
    portSlot.EntityData.ParentYangName = "port-slots"
    portSlot.EntityData.SegmentPath = "port-slot" + types.AddKeyToken(portSlot.Number, "number")
    portSlot.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/" + portSlot.EntityData.SegmentPath
    portSlot.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    portSlot.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    portSlot.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (port *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_Port) GetEntityData() *types.CommonEntityData {
    ...
    port.EntityData.ParentYangName = "port-slot"
    port.EntityData.SegmentPath = "port"
    port.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/" + port.EntityData.SegmentPath
    port.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    port.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    port.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_Port_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.ParentYangName = "port"
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/port/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_Port_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/port/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_Port_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/port/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_Port_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/port/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_Port_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/port/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.ParentYangName = "port-slot"
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_PortSlots_PortSlot_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/port-slots/port-slot/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (sensors *Inventory_Racks_Rack_Slots_Slot_Cards_Card_Sensors) GetEntityData() *types.CommonEntityData {
    ...
    sensors.EntityData.SegmentPath = "sensors"
    sensors.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/" + sensors.EntityData.SegmentPath
    sensors.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    sensors.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    sensors.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (sensor *Inventory_Racks_Rack_Slots_Slot_Cards_Card_Sensors_Sensor) GetEntityData() *types.CommonEntityData {
    ...
    sensor.EntityData.ParentYangName = "sensors"
    sensor.EntityData.SegmentPath = "sensor" + types.AddKeyToken(sensor.Number, "number")
    sensor.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sensors/" + sensor.EntityData.SegmentPath
    sensor.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    sensor.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    sensor.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_Sensors_Sensor_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.ParentYangName = "sensor"
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sensors/sensor/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_Sensors_Sensor_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sensors/sensor/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_Sensors_Sensor_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sensors/sensor/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_Sensors_Sensor_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sensors/sensor/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_Sensors_Sensor_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/sensors/sensor/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_Cards_Card_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_Cards_Card_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_Cards_Card_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_Cards_Card_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/cards/card/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicAttributes *Inventory_Racks_Rack_Slots_Slot_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fruInfo *Inventory_Racks_Rack_Slots_Slot_BasicAttributes_FruInfo) GetEntityData() *types.CommonEntityData {
    ...
    fruInfo.EntityData.ParentYangName = "basic-attributes"
    fruInfo.EntityData.SegmentPath = "fru-info"
    fruInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/basic-attributes/" + fruInfo.EntityData.SegmentPath
    fruInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fruInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fruInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (lastOperationalStateChange *Inventory_Racks_Rack_Slots_Slot_BasicAttributes_FruInfo_LastOperationalStateChange) GetEntityData() *types.CommonEntityData {
    ...
    lastOperationalStateChange.EntityData.ParentYangName = "fru-info"
    lastOperationalStateChange.EntityData.SegmentPath = "last-operational-state-change"
    lastOperationalStateChange.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/basic-attributes/fru-info/" + lastOperationalStateChange.EntityData.SegmentPath
    lastOperationalStateChange.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    lastOperationalStateChange.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    lastOperationalStateChange.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (moduleUpTime *Inventory_Racks_Rack_Slots_Slot_BasicAttributes_FruInfo_ModuleUpTime) GetEntityData() *types.CommonEntityData {
    ...
    moduleUpTime.EntityData.ParentYangName = "fru-info"
    moduleUpTime.EntityData.SegmentPath = "module-up-time"
    moduleUpTime.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/basic-attributes/fru-info/" + moduleUpTime.EntityData.SegmentPath
    moduleUpTime.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    moduleUpTime.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    moduleUpTime.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_Slots_Slot_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/slots/slot/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fanTrays *Inventory_Racks_Rack_FanTrays) GetEntityData() *types.CommonEntityData {
    ...
    fanTrays.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/" + fanTrays.EntityData.SegmentPath
...
func (fanTray *Inventory_Racks_Rack_FanTrays_FanTray) GetEntityData() *types.CommonEntityData {
    ...
    fanTray.EntityData.SegmentPath = "fan-tray" + types.AddKeyToken(fanTray.Number, "number")
    fanTray.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/fan-trays/" + fanTray.EntityData.SegmentPath
    ...
    fanTray.EntityData.Children.Append("basic-attributes", types.YChild{"BasicAttributes", &fanTray.BasicAttributes})
    fanTray.EntityData.Leafs = types.NewOrderedMap()
    fanTray.EntityData.Leafs.Append("number", types.YLeaf{"Number", fanTray.Number})

    fanTray.EntityData.YListKeys = []string {"Number"}

    return &(fanTray.EntityData)
}

// Inventory_Racks_Rack_FanTrays_FanTray_BasicAttributes
// Attributes
...
func (basicAttributes *Inventory_Racks_Rack_FanTrays_FanTray_BasicAttributes) GetEntityData() *types.CommonEntityData {
    basicAttributes.EntityData.YFilter = basicAttributes.YFilter
    basicAttributes.EntityData.YangName = "basic-attributes"
    basicAttributes.EntityData.BundleName = "cisco_ios_xr"
    basicAttributes.EntityData.ParentYangName = "fan-tray"
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/fan-trays/fan-tray/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
// Inventory_Racks_Rack_FanTrays_FanTray_BasicAttributes_BasicInfo
// Inventory information
...
func (basicInfo *Inventory_Racks_Rack_FanTrays_FanTray_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/fan-trays/fan-tray/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (powerSupplyZones *Inventory_Racks_Rack_PowerSupplyZones) GetEntityData() *types.CommonEntityData {
    powerSupplyZones.EntityData.YFilter = powerSupplyZones.YFilter
    powerSupplyZones.EntityData.YangName = "power-supply-zones"
    powerSupplyZones.EntityData.BundleName = "cisco_ios_xr"
    powerSupplyZones.EntityData.ParentYangName = "rack"
    powerSupplyZones.EntityData.SegmentPath = "power-supply-zones"
    powerSupplyZones.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/" + powerSupplyZones.EntityData.SegmentPath
    powerSupplyZones.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    powerSupplyZones.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    powerSupplyZones.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()

    powerSupplyZones.EntityData.Children = types.NewOrderedMap()
    powerSupplyZones.EntityData.Children.Append("power-supply-zone", types.YChild{"PowerSupplyZone", nil})
    for i := range powerSupplyZones.PowerSupplyZone {
        powerSupplyZones.EntityData.Children.Append(types.GetSegmentPath(powerSupplyZones.PowerSupplyZone[i]), types.YChild{"PowerSupplyZone", powerSupplyZones.PowerSupplyZone[i]})
    }
    powerSupplyZones.EntityData.Leafs = types.NewOrderedMap()

    powerSupplyZones.EntityData.YListKeys = []string {}

    return &(powerSupplyZones.EntityData)
}
...
func (powerSupplyZone *Inventory_Racks_Rack_PowerSupplyZones_PowerSupplyZone) GetEntityData() *types.CommonEntityData {
    powerSupplyZone.EntityData.YFilter = powerSupplyZone.YFilter
    powerSupplyZone.EntityData.YangName = "power-supply-zone"
    powerSupplyZone.EntityData.BundleName = "cisco_ios_xr"
    powerSupplyZone.EntityData.ParentYangName = "power-supply-zones"
    powerSupplyZone.EntityData.SegmentPath = "power-supply-zone" + types.AddKeyToken(powerSupplyZone.Number, "number")
    powerSupplyZone.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/power-supply-zones/" + powerSupplyZone.EntityData.SegmentPath
    powerSupplyZone.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    powerSupplyZone.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    powerSupplyZone.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()

    powerSupplyZone.EntityData.Children = types.NewOrderedMap()
    powerSupplyZone.EntityData.Children.Append("power-supply-zone-attributes", types.YChild{"PowerSupplyZoneAttributes", &powerSupplyZone.PowerSupplyZoneAttributes})
    powerSupplyZone.EntityData.Leafs = types.NewOrderedMap()
    powerSupplyZone.EntityData.Leafs.Append("number", types.YLeaf{"Number", powerSupplyZone.Number})

    powerSupplyZone.EntityData.YListKeys = []string {"Number"}

    return &(powerSupplyZone.EntityData)
}
...
func (powerSupplyZoneAttributes *Inventory_Racks_Rack_PowerSupplyZones_PowerSupplyZone_PowerSupplyZoneAttributes) GetEntityData() *types.CommonEntityData {
    powerSupplyZoneAttributes.EntityData.YFilter = powerSupplyZoneAttributes.YFilter
    powerSupplyZoneAttributes.EntityData.YangName = "power-supply-zone-attributes"
    powerSupplyZoneAttributes.EntityData.BundleName = "cisco_ios_xr"
    powerSupplyZoneAttributes.EntityData.ParentYangName = "power-supply-zone"
    powerSupplyZoneAttributes.EntityData.SegmentPath = "power-supply-zone-attributes"
    powerSupplyZoneAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/power-supply-zones/power-supply-zone/" + powerSupplyZoneAttributes.EntityData.SegmentPath
    powerSupplyZoneAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    powerSupplyZoneAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    powerSupplyZoneAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()

    powerSupplyZoneAttributes.EntityData.Children = types.NewOrderedMap()
    powerSupplyZoneAttributes.EntityData.Children.Append("power-supply-group-info", types.YChild{"PowerSupplyGroupInfo", &powerSupplyZoneAttributes.PowerSupplyGroupInfo})
    powerSupplyZoneAttributes.EntityData.Leafs = types.NewOrderedMap()

    powerSupplyZoneAttributes.EntityData.YListKeys = []string {}

    return &(powerSupplyZoneAttributes.EntityData)
}
...
func (powerSupplyGroupInfo *Inventory_Racks_Rack_PowerSupplyZones_PowerSupplyZone_PowerSupplyZoneAttributes_PowerSupplyGroupInfo) GetEntityData() *types.CommonEntityData {
    powerSupplyGroupInfo.EntityData.YFilter = powerSupplyGroupInfo.YFilter
    powerSupplyGroupInfo.EntityData.YangName = "power-supply-group-info"
    powerSupplyGroupInfo.EntityData.BundleName = "cisco_ios_xr"
    powerSupplyGroupInfo.EntityData.ParentYangName = "power-supply-zone-attributes"
    powerSupplyGroupInfo.EntityData.SegmentPath = "power-supply-group-info"
    powerSupplyGroupInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/power-supply-zones/power-supply-zone/power-supply-zone-attributes/" + powerSupplyGroupInfo.EntityData.SegmentPath
    powerSupplyGroupInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    powerSupplyGroupInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    powerSupplyGroupInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()

    powerSupplyGroupInfo.EntityData.Children = types.NewOrderedMap()
    powerSupplyGroupInfo.EntityData.Leafs = types.NewOrderedMap()
    powerSupplyGroupInfo.EntityData.Leafs.Append("power-group-redundancy-mode", types.YLeaf{"PowerGroupRedundancyMode", powerSupplyGroupInfo.PowerGroupRedundancyMode})
    powerSupplyGroupInfo.EntityData.Leafs.Append("power-group-power-units", types.YLeaf{"PowerGroupPowerUnits", powerSupplyGroupInfo.PowerGroupPowerUnits})
    powerSupplyGroupInfo.EntityData.Leafs.Append("power-group-available-current", types.YLeaf{"PowerGroupAvailableCurrent", powerSupplyGroupInfo.PowerGroupAvailableCurrent})
    powerSupplyGroupInfo.EntityData.Leafs.Append("power-group-drawn-current", types.YLeaf{"PowerGroupDrawnCurrent", powerSupplyGroupInfo.PowerGroupDrawnCurrent})

    powerSupplyGroupInfo.EntityData.YListKeys = []string {}

    return &(powerSupplyGroupInfo.EntityData)
}
...
func (basicAttributes *Inventory_Racks_Rack_BasicAttributes) GetEntityData() *types.CommonEntityData {
    ...
    basicAttributes.EntityData.YangName = "basic-attributes"
    basicAttributes.EntityData.BundleName = "cisco_ios_xr"
    basicAttributes.EntityData.ParentYangName = "rack"
    basicAttributes.EntityData.SegmentPath = "basic-attributes"
    basicAttributes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/" + basicAttributes.EntityData.SegmentPath
    basicAttributes.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicAttributes.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicAttributes.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (basicInfo *Inventory_Racks_Rack_BasicAttributes_BasicInfo) GetEntityData() *types.CommonEntityData {
    ...
    basicInfo.EntityData.ParentYangName = "basic-attributes"
    basicInfo.EntityData.SegmentPath = "basic-info"
    basicInfo.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-sc-invmgr-admin-oper:inventory/racks/rack/basic-attributes/" + basicInfo.EntityData.SegmentPath
    basicInfo.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    basicInfo.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    basicInfo.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
