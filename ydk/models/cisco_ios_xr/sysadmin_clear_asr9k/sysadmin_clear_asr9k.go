...
func (controller *Clear_Controller) GetEntityData() *types.CommonEntityData {
    ...
    controller.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/" + controller.EntityData.SegmentPath
...
func (self *Clear_Controller_Switch) GetEntityData() *types.CommonEntityData {
    ...
    self.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/controller/" + self.EntityData.SegmentPath
...
func (oper *Clear_Controller_Switch_Oper) GetEntityData() *types.CommonEntityData {
    ...
    oper.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/controller/switch/" + oper.EntityData.SegmentPath
...
func (fdb *Clear_Controller_Switch_Oper_Fdb) GetEntityData() *types.CommonEntityData {
    ...
    fdb.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/controller/switch/oper/" + fdb.EntityData.SegmentPath
...
func (location *Clear_Controller_Switch_Oper_Fdb_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/controller/switch/oper/fdb/" + location.EntityData.SegmentPath
...
func (statistics *Clear_Controller_Switch_Oper_Statistics) GetEntityData() *types.CommonEntityData {
    ...
    statistics.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/controller/switch/oper/" + statistics.EntityData.SegmentPath
...
func (location *Clear_Controller_Switch_Oper_Statistics_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.SegmentPath = "location" + types.AddKeyToken(location.Rack, "rack") + types.AddKeyToken(location.Card, "card") + types.AddKeyToken(location.SwitchId, "switch-id")
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/controller/switch/oper/statistics/" + location.EntityData.SegmentPath
    location.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    location.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    location.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (plugin *Clear_Plugin) GetEntityData() *types.CommonEntityData {
    ...
    plugin.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/" + plugin.EntityData.SegmentPath
...
func (slot *Clear_Plugin_Slot) GetEntityData() *types.CommonEntityData {
    ...
    slot.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/plugin/" + slot.EntityData.SegmentPath
...
func (location *Clear_Plugin_Slot_Location) GetEntityData() *types.CommonEntityData {
    ...
    location.EntityData.AbsolutePath = "Cisco-IOS-XR-sysadmin-clear-asr9k:clear/plugin/slot/" + location.EntityData.SegmentPath
    location.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    location.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    location.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
