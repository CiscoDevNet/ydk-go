...
func (dtiController *DtiController) GetEntityData() *types.CommonEntityData {
    ...
    dtiController.EntityData.Children = types.NewOrderedMap()
    dtiController.EntityData.Children.Append("nodes", types.YChild{"Nodes", &dtiController.Nodes})
    dtiController.EntityData.Leafs = types.NewOrderedMap()

    dtiController.EntityData.YListKeys = []string {}
...
func (node *DtiController_Nodes_Node) GetEntityData() *types.CommonEntityData {
    ...
    node.EntityData.Children.Append("port", types.YChild{"Port", &node.Port})
    node.EntityData.Children.Append("time-of-day", types.YChild{"TimeOfDay", &node.TimeOfDay})
...
func (client *DtiController_Nodes_Node_Client) GetEntityData() *types.CommonEntityData {
    ...
    client.EntityData.Leafs.Append("timestamp-comparator-enable", types.YLeaf{"TimestampComparatorEnable", client.TimestampComparatorEnable})
    client.EntityData.Leafs.Append("register-write-enable", types.YLeaf{"RegisterWriteEnable", client.RegisterWriteEnable})
    client.EntityData.Leafs.Append("revertive-mode-enable", types.YLeaf{"RevertiveModeEnable", client.RevertiveModeEnable})
    client.EntityData.Leafs.Append("port-mode-select", types.YLeaf{"PortModeSelect", client.PortModeSelect})
    client.EntityData.Leafs.Append("force-freerun", types.YLeaf{"ForceFreerun", client.ForceFreerun})
    client.EntityData.Leafs.Append("reference-select-port", types.YLeaf{"ReferenceSelectPort", client.ReferenceSelectPort})
    client.EntityData.Leafs.Append("timestamp-sync-detected", types.YLeaf{"TimestampSyncDetected", client.TimestampSyncDetected})
    client.EntityData.Leafs.Append("reference10mhz-detected", types.YLeaf{"Reference10mhzDetected", client.Reference10mhzDetected})
    client.EntityData.Leafs.Append("active-input-port", types.YLeaf{"ActiveInputPort", client.ActiveInputPort})
...
func (port *DtiController_Nodes_Node_Port) GetEntityData() *types.CommonEntityData {
    ...
    port.EntityData.Leafs.Append("port1-fr-err-rate-greater5-per", types.YLeaf{"Port1FrErrRateGreater5Per", port.Port1FrErrRateGreater5Per})
    port.EntityData.Leafs.Append("port1-fr-err-rate-greater2-per", types.YLeaf{"Port1FrErrRateGreater2Per", port.Port1FrErrRateGreater2Per})
    port.EntityData.Leafs.Append("port1-dti-signal-detected", types.YLeaf{"Port1DtiSignalDetected", port.Port1DtiSignalDetected})
    port.EntityData.Leafs.Append("port1-server-timing-source", types.YLeaf{"Port1ServerTimingSource", port.Port1ServerTimingSource})
    port.EntityData.Leafs.Append("port1-server-type", types.YLeaf{"Port1ServerType", port.Port1ServerType})
    port.EntityData.Leafs.Append("port1-server-clock-type", types.YLeaf{"Port1ServerClockType", port.Port1ServerClockType})
    port.EntityData.Leafs.Append("port1-server-state", types.YLeaf{"Port1ServerState", port.Port1ServerState})
    port.EntityData.Leafs.Append("port1-client-perf-stable", types.YLeaf{"Port1ClientPerfStable", port.Port1ClientPerfStable})
    port.EntityData.Leafs.Append("port1-cable-advance-valid", types.YLeaf{"Port1CableAdvanceValid", port.Port1CableAdvanceValid})
    port.EntityData.Leafs.Append("port2-fr-err-rate-greater5-per", types.YLeaf{"Port2FrErrRateGreater5Per", port.Port2FrErrRateGreater5Per})
    port.EntityData.Leafs.Append("port2-fr-err-rate-greater2-per", types.YLeaf{"Port2FrErrRateGreater2Per", port.Port2FrErrRateGreater2Per})
    port.EntityData.Leafs.Append("port2-dti-signal-detected", types.YLeaf{"Port2DtiSignalDetected", port.Port2DtiSignalDetected})
    port.EntityData.Leafs.Append("port2-server-timing-source", types.YLeaf{"Port2ServerTimingSource", port.Port2ServerTimingSource})
    port.EntityData.Leafs.Append("port2-server-type", types.YLeaf{"Port2ServerType", port.Port2ServerType})
    port.EntityData.Leafs.Append("port2-server-clock-type", types.YLeaf{"Port2ServerClockType", port.Port2ServerClockType})
    port.EntityData.Leafs.Append("port2-server-state", types.YLeaf{"Port2ServerState", port.Port2ServerState})
    port.EntityData.Leafs.Append("port2-client-perf-stable", types.YLeaf{"Port2ClientPerfStable", port.Port2ClientPerfStable})
    port.EntityData.Leafs.Append("port2-cable-advance-valid", types.YLeaf{"Port2CableAdvanceValid", port.Port2CableAdvanceValid})
...
func (timeOfDay *DtiController_Nodes_Node_TimeOfDay) GetEntityData() *types.CommonEntityData {
    ...
    timeOfDay.EntityData.Children = types.NewOrderedMap()
    timeOfDay.EntityData.Leafs = types.NewOrderedMap()
    timeOfDay.EntityData.Leafs.Append("port1-tod-message-mode", types.YLeaf{"Port1TodMessageMode", timeOfDay.Port1TodMessageMode})
    timeOfDay.EntityData.Leafs.Append("port1-tod-state", types.YLeaf{"Port1TodState", timeOfDay.Port1TodState})
    timeOfDay.EntityData.Leafs.Append("port1-tod-time-setting-mode", types.YLeaf{"Port1TodTimeSettingMode", timeOfDay.Port1TodTimeSettingMode})
    timeOfDay.EntityData.Leafs.Append("port1-gps-seconds", types.YLeaf{"Port1GpsSeconds", timeOfDay.Port1GpsSeconds})
    timeOfDay.EntityData.Leafs.Append("port1-leap-seconds", types.YLeaf{"Port1LeapSeconds", timeOfDay.Port1LeapSeconds})
    timeOfDay.EntityData.Leafs.Append("port1-calendar-time-valid", types.YLeaf{"Port1CalendarTimeValid", timeOfDay.Port1CalendarTimeValid})
    timeOfDay.EntityData.Leafs.Append("port1-modified-julian-date", types.YLeaf{"Port1ModifiedJulianDate", timeOfDay.Port1ModifiedJulianDate})
    timeOfDay.EntityData.Leafs.Append("port1-date", types.YLeaf{"Port1Date", timeOfDay.Port1Date})
    timeOfDay.EntityData.Leafs.Append("port1-time", types.YLeaf{"Port1Time", timeOfDay.Port1Time})
    timeOfDay.EntityData.Leafs.Append("port1-time-zone-offset", types.YLeaf{"Port1TimeZoneOffset", timeOfDay.Port1TimeZoneOffset})
    timeOfDay.EntityData.Leafs.Append("port1-leap-second-indicator", types.YLeaf{"Port1LeapSecondIndicator", timeOfDay.Port1LeapSecondIndicator})
    timeOfDay.EntityData.Leafs.Append("port2-tod-message-mode", types.YLeaf{"Port2TodMessageMode", timeOfDay.Port2TodMessageMode})
    timeOfDay.EntityData.Leafs.Append("port2-tod-state", types.YLeaf{"Port2TodState", timeOfDay.Port2TodState})
    timeOfDay.EntityData.Leafs.Append("port2-tod-time-setting-mode", types.YLeaf{"Port2TodTimeSettingMode", timeOfDay.Port2TodTimeSettingMode})
    timeOfDay.EntityData.Leafs.Append("port2-gps-seconds", types.YLeaf{"Port2GpsSeconds", timeOfDay.Port2GpsSeconds})
    timeOfDay.EntityData.Leafs.Append("port2-leap-seconds", types.YLeaf{"Port2LeapSeconds", timeOfDay.Port2LeapSeconds})
    timeOfDay.EntityData.Leafs.Append("port2-calendar-time-valid", types.YLeaf{"Port2CalendarTimeValid", timeOfDay.Port2CalendarTimeValid})
    timeOfDay.EntityData.Leafs.Append("port2-modified-julian-date", types.YLeaf{"Port2ModifiedJulianDate", timeOfDay.Port2ModifiedJulianDate})
    timeOfDay.EntityData.Leafs.Append("port2-date", types.YLeaf{"Port2Date", timeOfDay.Port2Date})
    timeOfDay.EntityData.Leafs.Append("port2-time", types.YLeaf{"Port2Time", timeOfDay.Port2Time})
    timeOfDay.EntityData.Leafs.Append("port2-time-zone-offset", types.YLeaf{"Port2TimeZoneOffset", timeOfDay.Port2TimeZoneOffset})
    timeOfDay.EntityData.Leafs.Append("port2-leap-second-indicator", types.YLeaf{"Port2LeapSecondIndicator", timeOfDay.Port2LeapSecondIndicator})

    timeOfDay.EntityData.YListKeys = []string {}
