...
func (netFlow *NetFlow) GetParentYangName() string { return "Cisco-IOS-XR-skywarp-netflow-oper" }
...
func (statistics *NetFlow_Statistics_Statistic_Producer_Statistics) GetGoName(yname string) string {
    if yname == "ethernet-pkts" { return "EthernetPkts" }
    ...
    if yname == "spp-rx-counts" { return "SppRxCounts" }
    if yname == "flow-packet-counts" { return "FlowPacketCounts" }
...
func (statistics *NetFlow_Statistics_Statistic_Producer_Statistics) GetLeafs() map[string]interface{} {
    leafs := make(map[string]interface{})
    leafs["ethernet-pkts"] = statistics.EthernetPkts
    ...
    leafs["spp-rx-counts"] = statistics.SppRxCounts
    leafs["flow-packet-counts"] = statistics.FlowPacketCounts
