...
func init() {
    ydk.YLogDebug(fmt.Sprintf("Registering top level entities for package skywarp_netflow_oper"))
    ydk.RegisterEntity("{http://cisco.com/ns/yang/Cisco-IOS-XR-skywarp-netflow-oper net-flow}", reflect.TypeOf(NetFlow{}))
    ydk.RegisterEntity("Cisco-IOS-XR-skywarp-netflow-oper:net-flow", reflect.TypeOf(NetFlow{}))
}
...
func (netFlow *NetFlow) GetEntityData() *types.CommonEntityData {
    ...
    netFlow.EntityData.ParentYangName = "Cisco-IOS-XR-skywarp-netflow-oper"
    netFlow.EntityData.SegmentPath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow"
...
func (statistics *NetFlow_Statistics) GetEntityData() *types.CommonEntityData {
    ...
    statistics.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/" + statistics.EntityData.SegmentPath
...
func (statistic *NetFlow_Statistics_Statistic) GetEntityData() *types.CommonEntityData {
    ...
    statistic.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/" + statistic.EntityData.SegmentPath
...
func (producer *NetFlow_Statistics_Statistic_Producer) GetEntityData() *types.CommonEntityData {
    ...
    producer.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/" + producer.EntityData.SegmentPath
...
type NetFlow_Statistics_Statistic_Producer_Statistics struct {
    ...
    // Ethernet Packets. The type is interface{} with range:
    // 0..18446744073709551615.
    EthernetPkts interface{}
...
func (statistics *NetFlow_Statistics_Statistic_Producer_Statistics) GetEntityData() *types.CommonEntityData {
    ...
    statistics.EntityData.SegmentPath = "statistics"
    statistics.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/producer/" + statistics.EntityData.SegmentPath
    statistics.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    statistics.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    statistics.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
    ...
    statistics.EntityData.Children = types.NewOrderedMap()
    statistics.EntityData.Leafs = types.NewOrderedMap()
    statistics.EntityData.Leafs.Append("ethernet-pkts", types.YLeaf{"EthernetPkts", statistics.EthernetPkts})
...
func (server *NetFlow_Statistics_Statistic_Server) GetEntityData() *types.CommonEntityData {
    ...
    server.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/" + server.EntityData.SegmentPath
...
func (flowExporters *NetFlow_Statistics_Statistic_Server_FlowExporters) GetEntityData() *types.CommonEntityData {
    ...
    flowExporters.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/server/" + flowExporters.EntityData.SegmentPath
...
func (flowExporter *NetFlow_Statistics_Statistic_Server_FlowExporters_FlowExporter) GetEntityData() *types.CommonEntityData {
    ...
    flowExporter.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/server/flow-exporters/" + flowExporter.EntityData.SegmentPath
...
func (exporter *NetFlow_Statistics_Statistic_Server_FlowExporters_FlowExporter_Exporter) GetEntityData() *types.CommonEntityData {
    ...
    exporter.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/server/flow-exporters/flow-exporter/" + exporter.EntityData.SegmentPath
...
func (statistic *NetFlow_Statistics_Statistic_Server_FlowExporters_FlowExporter_Exporter_Statistic) GetEntityData() *types.CommonEntityData {
    ...
    statistic.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/server/flow-exporters/flow-exporter/exporter/" + statistic.EntityData.SegmentPath
    statistic.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    statistic.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    statistic.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (collector *NetFlow_Statistics_Statistic_Server_FlowExporters_FlowExporter_Exporter_Statistic_Collector) GetEntityData() *types.CommonEntityData {
    ...
    collector.EntityData.AbsolutePath = "Cisco-IOS-XR-skywarp-netflow-oper:net-flow/statistics/statistic/server/flow-exporters/flow-exporter/exporter/statistic/" + collector.EntityData.SegmentPath
