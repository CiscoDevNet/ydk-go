...
func (dpa *Dpa) GetChildren() map[string]types.Entity {
    ...
    children["resources"] = &dpa.Resources
...
func (dpa *Dpa) GetParentYangName() string { return "Cisco-IOS-XR-fretta-bcm-dpa-resources-oper" }
...
func (resources *Dpa_Resources) GetFilter() yfilter.YFilter { return resources.YFilter }

func (resources *Dpa_Resources) SetFilter(yf yfilter.YFilter) { resources.YFilter = yf }

func (resources *Dpa_Resources) GetGoName(yname string) string {
    if yname == "nodes" { return "Nodes" }
    return ""
}

func (resources *Dpa_Resources) GetSegmentPath() string {
    return "resources"
}

func (resources *Dpa_Resources) GetChildByName(childYangName string, segmentPath string) types.Entity {
...
func (resources *Dpa_Resources) GetChildren() map[string]types.Entity {
    children := make(map[string]types.Entity)
    children["nodes"] = &resources.Nodes
    return children
}

func (resources *Dpa_Resources) GetLeafs() map[string]interface{} {
    leafs := make(map[string]interface{})
    return leafs
}

func (resources *Dpa_Resources) GetBundleName() string { return "cisco_ios_xr" }

func (resources *Dpa_Resources) GetYangName() string { return "resources" }

func (resources *Dpa_Resources) GetBundleYangModelsLocation() string { return cisco_ios_xr.GetModelsPath() }

func (resources *Dpa_Resources) GetCapabilitiesTable() map[string]string {
    return cisco_ios_xr.GetCapabilities() }

func (resources *Dpa_Resources) GetNamespaceTable() map[string]string {
    return cisco_ios_xr.GetNamespaces() }

func (resources *Dpa_Resources) SetParent(parent types.Entity) { resources.parent = parent }

func (resources *Dpa_Resources) GetParent() types.Entity { return resources.parent }

func (resources *Dpa_Resources) GetParentYangName() string { return "dpa" }
...
func (nodes *Dpa_Resources_Nodes) GetFilter() yfilter.YFilter { return nodes.YFilter }

func (nodes *Dpa_Resources_Nodes) SetFilter(yf yfilter.YFilter) { nodes.YFilter = yf }

func (nodes *Dpa_Resources_Nodes) GetGoName(yname string) string {
    if yname == "node" { return "Node" }
    return ""
}

func (nodes *Dpa_Resources_Nodes) GetSegmentPath() string {
    return "nodes"
}

func (nodes *Dpa_Resources_Nodes) GetChildByName(childYangName string, segmentPath string) types.Entity {
    if childYangName == "node" {
        ...
        child := Dpa_Resources_Nodes_Node{}
...
func (nodes *Dpa_Resources_Nodes) GetChildren() map[string]types.Entity {
    children := make(map[string]types.Entity)
...
func (nodes *Dpa_Resources_Nodes) GetLeafs() map[string]interface{} {
    leafs := make(map[string]interface{})
    return leafs
}

func (nodes *Dpa_Resources_Nodes) GetBundleName() string { return "cisco_ios_xr" }

func (nodes *Dpa_Resources_Nodes) GetYangName() string { return "nodes" }

func (nodes *Dpa_Resources_Nodes) GetBundleYangModelsLocation() string { return cisco_ios_xr.GetModelsPath() }

func (nodes *Dpa_Resources_Nodes) GetCapabilitiesTable() map[string]string {
    return cisco_ios_xr.GetCapabilities() }

func (nodes *Dpa_Resources_Nodes) GetNamespaceTable() map[string]string {
    return cisco_ios_xr.GetNamespaces() }

func (nodes *Dpa_Resources_Nodes) SetParent(parent types.Entity) { nodes.parent = parent }

func (nodes *Dpa_Resources_Nodes) GetParent() types.Entity { return nodes.parent }

func (nodes *Dpa_Resources_Nodes) GetParentYangName() string { return "resources" }
...
func (node *Dpa_Resources_Nodes_Node) GetFilter() yfilter.YFilter { return node.YFilter }

func (node *Dpa_Resources_Nodes_Node) SetFilter(yf yfilter.YFilter) { node.YFilter = yf }

func (node *Dpa_Resources_Nodes_Node) GetGoName(yname string) string {
    if yname == "node-name" { return "NodeName" }
    if yname == "table-datas" { return "TableDatas" }
    return ""
}

func (node *Dpa_Resources_Nodes_Node) GetSegmentPath() string {
    return "node" + "[node-name='" + fmt.Sprintf("%v", node.NodeName) + "']"
}

func (node *Dpa_Resources_Nodes_Node) GetChildByName(childYangName string, segmentPath string) types.Entity {
    if childYangName == "table-datas" {
        return &node.TableDatas
    }
    return nil
}

func (node *Dpa_Resources_Nodes_Node) GetChildren() map[string]types.Entity {
    children := make(map[string]types.Entity)
    children["table-datas"] = &node.TableDatas
    return children
}

func (node *Dpa_Resources_Nodes_Node) GetLeafs() map[string]interface{} {
    leafs := make(map[string]interface{})
    leafs["node-name"] = node.NodeName
    return leafs
}

func (node *Dpa_Resources_Nodes_Node) GetBundleName() string { return "cisco_ios_xr" }

func (node *Dpa_Resources_Nodes_Node) GetYangName() string { return "node" }

func (node *Dpa_Resources_Nodes_Node) GetBundleYangModelsLocation() string { return cisco_ios_xr.GetModelsPath() }

func (node *Dpa_Resources_Nodes_Node) GetCapabilitiesTable() map[string]string {
    return cisco_ios_xr.GetCapabilities() }

func (node *Dpa_Resources_Nodes_Node) GetNamespaceTable() map[string]string {
    return cisco_ios_xr.GetNamespaces() }

func (node *Dpa_Resources_Nodes_Node) SetParent(parent types.Entity) { node.parent = parent }

func (node *Dpa_Resources_Nodes_Node) GetParent() types.Entity { return node.parent }

func (node *Dpa_Resources_Nodes_Node) GetParentYangName() string { return "nodes" }
...
type Dpa_Resources_Nodes_Node_TableDatas struct {
    ...
    // Resources table. The type is slice of
    // Dpa_Resources_Nodes_Node_TableDatas_TableData.
    TableData []Dpa_Resources_Nodes_Node_TableDatas_TableData
}

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetFilter() yfilter.YFilter { return tableDatas.YFilter }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) SetFilter(yf yfilter.YFilter) { tableDatas.YFilter = yf }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetGoName(yname string) string {
    if yname == "table-data" { return "TableData" }
    return ""
}

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetSegmentPath() string {
    return "table-datas"
}

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetChildByName(childYangName string, segmentPath string) types.Entity {
    if childYangName == "table-data" {
        for _, c := range tableDatas.TableData {
            if tableDatas.GetSegmentPath() == segmentPath {
                return &c
            }
        }
        child := Dpa_Resources_Nodes_Node_TableDatas_TableData{}
        tableDatas.TableData = append(tableDatas.TableData, child)
        return &tableDatas.TableData[len(tableDatas.TableData)-1]
    }
    return nil
}

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetChildren() map[string]types.Entity {
    children := make(map[string]types.Entity)
    for i := range tableDatas.TableData {
        children[tableDatas.TableData[i].GetSegmentPath()] = &tableDatas.TableData[i]
    }
    return children
}

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetLeafs() map[string]interface{} {
    leafs := make(map[string]interface{})
    return leafs
}

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetBundleName() string { return "cisco_ios_xr" }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetYangName() string { return "table-datas" }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetBundleYangModelsLocation() string { return cisco_ios_xr.GetModelsPath() }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetCapabilitiesTable() map[string]string {
    return cisco_ios_xr.GetCapabilities() }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetNamespaceTable() map[string]string {
    return cisco_ios_xr.GetNamespaces() }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) SetParent(parent types.Entity) { tableDatas.parent = parent }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetParent() types.Entity { return tableDatas.parent }

func (tableDatas *Dpa_Resources_Nodes_Node_TableDatas) GetParentYangName() string { return "node" }
...
type Dpa_Resources_Nodes_Node_TableDatas_TableData struct {
    ...
    // This attribute is a key. Resource type. The type is interface{} with range:
    // 0..124.
    Resource interface{}
...
func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetFilter() yfilter.YFilter { return tableData.YFilter }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) SetFilter(yf yfilter.YFilter) { tableData.YFilter = yf }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetGoName(yname string) string {
    if yname == "resource" { return "Resource" }
    if yname == "table-id" { return "TableId" }
    if yname == "name" { return "Name" }
    if yname == "is-global" { return "IsGlobal" }
    if yname == "num-npus" { return "NumNpus" }
    if yname == "table-specific-list" { return "TableSpecificList" }
    if yname == "npu-tblr" { return "NpuTblr" }
    return ""
}

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetSegmentPath() string {
    return "table-data" + "[resource='" + fmt.Sprintf("%v", tableData.Resource) + "']"
}

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetChildByName(childYangName string, segmentPath string) types.Entity {
    if childYangName == "npu-tblr" {
        for _, c := range tableData.NpuTblr {
            if tableData.GetSegmentPath() == segmentPath {
                return &c
            }
        }
        child := Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr{}
        tableData.NpuTblr = append(tableData.NpuTblr, child)
        return &tableData.NpuTblr[len(tableData.NpuTblr)-1]
    }
    return nil
}

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetChildren() map[string]types.Entity {
    children := make(map[string]types.Entity)
    for i := range tableData.NpuTblr {
        children[tableData.NpuTblr[i].GetSegmentPath()] = &tableData.NpuTblr[i]
    }
    return children
}

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetLeafs() map[string]interface{} {
    leafs := make(map[string]interface{})
    leafs["resource"] = tableData.Resource
    leafs["table-id"] = tableData.TableId
    leafs["name"] = tableData.Name
    leafs["is-global"] = tableData.IsGlobal
    leafs["num-npus"] = tableData.NumNpus
    leafs["table-specific-list"] = tableData.TableSpecificList
    return leafs
}

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetBundleName() string { return "cisco_ios_xr" }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetYangName() string { return "table-data" }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetBundleYangModelsLocation() string { return cisco_ios_xr.GetModelsPath() }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetCapabilitiesTable() map[string]string {
    return cisco_ios_xr.GetCapabilities() }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetNamespaceTable() map[string]string {
    return cisco_ios_xr.GetNamespaces() }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) SetParent(parent types.Entity) { tableData.parent = parent }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetParent() types.Entity { return tableData.parent }

func (tableData *Dpa_Resources_Nodes_Node_TableDatas_TableData) GetParentYangName() string { return "table-datas" }
...
func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetFilter() yfilter.YFilter { return npuTblr.YFilter }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) SetFilter(yf yfilter.YFilter) { npuTblr.YFilter = yf }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetGoName(yname string) string {
    if yname == "npu-id" { return "NpuId" }
    if yname == "num-objs" { return "NumObjs" }
    if yname == "create-req" { return "CreateReq" }
    if yname == "create-ok" { return "CreateOk" }
    if yname == "delete-req" { return "DeleteReq" }
    if yname == "delete-ok" { return "DeleteOk" }
    if yname == "update-req" { return "UpdateReq" }
    if yname == "update-ok" { return "UpdateOk" }
    if yname == "eod-req" { return "EodReq" }
    if yname == "eod-ok" { return "EodOk" }
    if yname == "err-hw-fail" { return "ErrHwFail" }
    if yname == "err-ref-resolve" { return "ErrRefResolve" }
    if yname == "err-db-notfound" { return "ErrDbNotfound" }
    if yname == "err-db-exists" { return "ErrDbExists" }
    if yname == "err-db-nomem" { return "ErrDbNomem" }
    return ""
}

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetSegmentPath() string {
    return "npu-tblr"
}

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetChildByName(childYangName string, segmentPath string) types.Entity {
    return nil
}

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetChildren() map[string]types.Entity {
    children := make(map[string]types.Entity)
    return children
}

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetLeafs() map[string]interface{} {
    leafs := make(map[string]interface{})
    leafs["npu-id"] = npuTblr.NpuId
    leafs["num-objs"] = npuTblr.NumObjs
    leafs["create-req"] = npuTblr.CreateReq
    leafs["create-ok"] = npuTblr.CreateOk
    leafs["delete-req"] = npuTblr.DeleteReq
    leafs["delete-ok"] = npuTblr.DeleteOk
    leafs["update-req"] = npuTblr.UpdateReq
    leafs["update-ok"] = npuTblr.UpdateOk
    leafs["eod-req"] = npuTblr.EodReq
    leafs["eod-ok"] = npuTblr.EodOk
    leafs["err-hw-fail"] = npuTblr.ErrHwFail
    leafs["err-ref-resolve"] = npuTblr.ErrRefResolve
    leafs["err-db-notfound"] = npuTblr.ErrDbNotfound
    leafs["err-db-exists"] = npuTblr.ErrDbExists
    leafs["err-db-nomem"] = npuTblr.ErrDbNomem
    return leafs
}

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetBundleName() string { return "cisco_ios_xr" }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetYangName() string { return "npu-tblr" }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetBundleYangModelsLocation() string { return cisco_ios_xr.GetModelsPath() }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetCapabilitiesTable() map[string]string {
    return cisco_ios_xr.GetCapabilities() }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetNamespaceTable() map[string]string {
    return cisco_ios_xr.GetNamespaces() }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) SetParent(parent types.Entity) { npuTblr.parent = parent }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetParent() types.Entity { return npuTblr.parent }

func (npuTblr *Dpa_Resources_Nodes_Node_TableDatas_TableData_NpuTblr) GetParentYangName() string { return "table-data" }
