...
func (nodePath *NodePath) GetEntityData() *types.CommonEntityData {
    ...
    nodePath.EntityData.AbsolutePath = nodePath.EntityData.SegmentPath
...
func (node *NodePath_Node) GetEntityData() *types.CommonEntityData {
    ...
    node.EntityData.AbsolutePath = "Cisco-IOS-XR-slice-mgr-proxy-cfg:node-path/" + node.EntityData.SegmentPath
...
func (sliceIds *NodePath_Node_SliceIds) GetEntityData() *types.CommonEntityData {
    ...
    sliceIds.EntityData.AbsolutePath = "Cisco-IOS-XR-slice-mgr-proxy-cfg:node-path/node/" + sliceIds.EntityData.SegmentPath
...
func (sliceId *NodePath_Node_SliceIds_SliceId) GetEntityData() *types.CommonEntityData {
    ...
    sliceId.EntityData.AbsolutePath = "Cisco-IOS-XR-slice-mgr-proxy-cfg:node-path/node/slice-ids/" + sliceId.EntityData.SegmentPath
