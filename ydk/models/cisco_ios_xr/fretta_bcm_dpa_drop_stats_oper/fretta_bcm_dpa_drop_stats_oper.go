...
func (drop *Drop) GetEntityData() *types.CommonEntityData {
    ...
    drop.EntityData.Children["nodes"] = types.YChild{"Nodes", &drop.Nodes}
...
func (node *Drop_Nodes_Node) GetEntityData() *types.CommonEntityData {
    ...
    node.EntityData.Children["npu-number-for-drop-stats"] = types.YChild{"NpuNumberForDropStats", &node.NpuNumberForDropStats}
...
func (npuNumberForDropStats *Drop_Nodes_Node_NpuNumberForDropStats) GetEntityData() *types.CommonEntityData {
    ...
    npuNumberForDropStats.EntityData.Children = make(map[string]types.YChild)
    npuNumberForDropStats.EntityData.Children["npu-number-for-drop-stat"] = types.YChild{"NpuNumberForDropStat", nil}
    for i := range npuNumberForDropStats.NpuNumberForDropStat {
        npuNumberForDropStats.EntityData.Children[types.GetSegmentPath(&npuNumberForDropStats.NpuNumberForDropStat[i])] = types.YChild{"NpuNumberForDropStat", &npuNumberForDropStats.NpuNumberForDropStat[i]}
    }
    npuNumberForDropStats.EntityData.Leafs = make(map[string]types.YLeaf)
...
func (npuNumberForDropStat *Drop_Nodes_Node_NpuNumberForDropStats_NpuNumberForDropStat) GetEntityData() *types.CommonEntityData {
    ...
    npuNumberForDropStat.EntityData.SegmentPath = "npu-number-for-drop-stat" + "[npu-id='" + fmt.Sprintf("%v", npuNumberForDropStat.NpuId) + "']"
    ...
    npuNumberForDropStat.EntityData.Children = make(map[string]types.YChild)
    npuNumberForDropStat.EntityData.Children["drop-specific-stats-data"] = types.YChild{"DropSpecificStatsData", nil}
    for i := range npuNumberForDropStat.DropSpecificStatsData {
        npuNumberForDropStat.EntityData.Children[types.GetSegmentPath(&npuNumberForDropStat.DropSpecificStatsData[i])] = types.YChild{"DropSpecificStatsData", &npuNumberForDropStat.DropSpecificStatsData[i]}
    }
    npuNumberForDropStat.EntityData.Leafs = make(map[string]types.YLeaf)
    npuNumberForDropStat.EntityData.Leafs["npu-id"] = types.YLeaf{"NpuId", npuNumberForDropStat.NpuId}
...
func (dropSpecificStatsData *Drop_Nodes_Node_NpuNumberForDropStats_NpuNumberForDropStat_DropSpecificStatsData) GetEntityData() *types.CommonEntityData {
    ...
    dropSpecificStatsData.EntityData.SegmentPath = "drop-specific-stats-data" + "[drop-data='" + fmt.Sprintf("%v", dropSpecificStatsData.DropData) + "']"
    ...
    dropSpecificStatsData.EntityData.Children = make(map[string]types.YChild)
    dropSpecificStatsData.EntityData.Leafs = make(map[string]types.YLeaf)
    dropSpecificStatsData.EntityData.Leafs["drop-data"] = types.YLeaf{"DropData", dropSpecificStatsData.DropData}
    dropSpecificStatsData.EntityData.Leafs["id"] = types.YLeaf{"Id", dropSpecificStatsData.Id}
    dropSpecificStatsData.EntityData.Leafs["name"] = types.YLeaf{"Name", dropSpecificStatsData.Name}
    dropSpecificStatsData.EntityData.Leafs["count"] = types.YLeaf{"Count", dropSpecificStatsData.Count}
