...
func (asicErrorStats *AsicErrorStats) GetEntityData() *types.CommonEntityData {
    ...
    asicErrorStats.EntityData.AbsolutePath = asicErrorStats.EntityData.SegmentPath
...
func (racks *AsicErrorStats_Racks) GetEntityData() *types.CommonEntityData {
    ...
    racks.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-asic-errors-oper:asic-error-stats/" + racks.EntityData.SegmentPath
...
func (rack *AsicErrorStats_Racks_Rack) GetEntityData() *types.CommonEntityData {
    ...
    rack.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-asic-errors-oper:asic-error-stats/racks/" + rack.EntityData.SegmentPath
...
func (nodes *AsicErrorStats_Racks_Rack_Nodes) GetEntityData() *types.CommonEntityData {
    ...
    nodes.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-asic-errors-oper:asic-error-stats/racks/rack/" + nodes.EntityData.SegmentPath
...
func (node *AsicErrorStats_Racks_Rack_Nodes_Node) GetEntityData() *types.CommonEntityData {
    ...
    node.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-asic-errors-oper:asic-error-stats/racks/rack/nodes/" + node.EntityData.SegmentPath
...
func (counts *AsicErrorStats_Racks_Rack_Nodes_Node_Counts) GetEntityData() *types.CommonEntityData {
    ...
    counts.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-asic-errors-oper:asic-error-stats/racks/rack/nodes/node/" + counts.EntityData.SegmentPath
...
func (count *AsicErrorStats_Racks_Rack_Nodes_Node_Counts_Count) GetEntityData() *types.CommonEntityData {
    ...
    count.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-asic-errors-oper:asic-error-stats/racks/rack/nodes/node/counts/" + count.EntityData.SegmentPath
    ...
    for i := range count.SumData {
        types.SetYListKey(count.SumData[i], i)
...
func (sumData *AsicErrorStats_Racks_Rack_Nodes_Node_Counts_Count_SumData) GetEntityData() *types.CommonEntityData {
    ...
    sumData.EntityData.AbsolutePath = "Cisco-IOS-XR-asr9k-asic-errors-oper:asic-error-stats/racks/rack/nodes/node/counts/count/" + sumData.EntityData.SegmentPath
