...
func (esAcl *EsAcl) GetEntityData() *types.CommonEntityData {
    ...
    esAcl.EntityData.Children["active"] = types.YChild{"Active", &esAcl.Active}
...
func (active *EsAcl_Active) GetEntityData() *types.CommonEntityData {
    ...
    active.EntityData.Children["oor"] = types.YChild{"Oor", &active.Oor}
    active.EntityData.Children["list"] = types.YChild{"List", &active.List}
    active.EntityData.Children["oor-acls"] = types.YChild{"OorAcls", &active.OorAcls}
    active.EntityData.Children["usages"] = types.YChild{"Usages", &active.Usages}
...
func (oor *EsAcl_Active_Oor) GetEntityData() *types.CommonEntityData {
    ...
    oor.EntityData.Children["acl-summary"] = types.YChild{"AclSummary", &oor.AclSummary}
...
func (aclSummary *EsAcl_Active_Oor_AclSummary) GetEntityData() *types.CommonEntityData {
    ...
    aclSummary.EntityData.Children = make(map[string]types.YChild)
    aclSummary.EntityData.Children["details"] = types.YChild{"Details", &aclSummary.Details}
    aclSummary.EntityData.Leafs = make(map[string]types.YLeaf)
...
func (details *EsAcl_Active_Oor_AclSummary_Details) GetEntityData() *types.CommonEntityData {
    ...
    details.EntityData.Leafs["maximum-configurable-ac-ls"] = types.YLeaf{"MaximumConfigurableAcLs", details.MaximumConfigurableAcLs}
    details.EntityData.Leafs["maximum-configurable-ac-es"] = types.YLeaf{"MaximumConfigurableAcEs", details.MaximumConfigurableAcEs}
...
func (list *EsAcl_Active_List) GetEntityData() *types.CommonEntityData {
    ...
    list.EntityData.Children["acls"] = types.YChild{"Acls", &list.Acls}
...
func (acls *EsAcl_Active_List_Acls) GetEntityData() *types.CommonEntityData {
    ...
    acls.EntityData.Children = make(map[string]types.YChild)
    acls.EntityData.Children["acl"] = types.YChild{"Acl", nil}
    for i := range acls.Acl {
        acls.EntityData.Children[types.GetSegmentPath(&acls.Acl[i])] = types.YChild{"Acl", &acls.Acl[i]}
    }
    acls.EntityData.Leafs = make(map[string]types.YLeaf)
...
func (acl *EsAcl_Active_List_Acls_Acl) GetEntityData() *types.CommonEntityData {
    ...
    acl.EntityData.SegmentPath = "acl" + "[name='" + fmt.Sprintf("%v", acl.Name) + "']"
    ...
    acl.EntityData.Children["acl-sequence-numbers"] = types.YChild{"AclSequenceNumbers", &acl.AclSequenceNumbers}
    acl.EntityData.Leafs = make(map[string]types.YLeaf)
    acl.EntityData.Leafs["name"] = types.YLeaf{"Name", acl.Name}
...
func (aclSequenceNumbers *EsAcl_Active_List_Acls_Acl_AclSequenceNumbers) GetEntityData() *types.CommonEntityData {
    ...
    aclSequenceNumbers.EntityData.Children = make(map[string]types.YChild)
    aclSequenceNumbers.EntityData.Children["acl-sequence-number"] = types.YChild{"AclSequenceNumber", nil}
    for i := range aclSequenceNumbers.AclSequenceNumber {
        aclSequenceNumbers.EntityData.Children[types.GetSegmentPath(&aclSequenceNumbers.AclSequenceNumber[i])] = types.YChild{"AclSequenceNumber", &aclSequenceNumbers.AclSequenceNumber[i]}
    }
    aclSequenceNumbers.EntityData.Leafs = make(map[string]types.YLeaf)
...
func (aclSequenceNumber *EsAcl_Active_List_Acls_Acl_AclSequenceNumbers_AclSequenceNumber) GetEntityData() *types.CommonEntityData {
    ...
    aclSequenceNumber.EntityData.SegmentPath = "acl-sequence-number" + "[sequence-number='" + fmt.Sprintf("%v", aclSequenceNumber.SequenceNumber) + "']"
    ...
    aclSequenceNumber.EntityData.Children = make(map[string]types.YChild)
    aclSequenceNumber.EntityData.Leafs = make(map[string]types.YLeaf)
    aclSequenceNumber.EntityData.Leafs["sequence-number"] = types.YLeaf{"SequenceNumber", aclSequenceNumber.SequenceNumber}
    aclSequenceNumber.EntityData.Leafs["ace-type"] = types.YLeaf{"AceType", aclSequenceNumber.AceType}
    aclSequenceNumber.EntityData.Leafs["ace-sequence-number"] = types.YLeaf{"AceSequenceNumber", aclSequenceNumber.AceSequenceNumber}
    aclSequenceNumber.EntityData.Leafs["hits"] = types.YLeaf{"Hits", aclSequenceNumber.Hits}
    aclSequenceNumber.EntityData.Leafs["grant"] = types.YLeaf{"Grant", aclSequenceNumber.Grant}
    aclSequenceNumber.EntityData.Leafs["source-address"] = types.YLeaf{"SourceAddress", aclSequenceNumber.SourceAddress}
    aclSequenceNumber.EntityData.Leafs["source-wild-card-bits"] = types.YLeaf{"SourceWildCardBits", aclSequenceNumber.SourceWildCardBits}
    aclSequenceNumber.EntityData.Leafs["destination-address"] = types.YLeaf{"DestinationAddress", aclSequenceNumber.DestinationAddress}
    aclSequenceNumber.EntityData.Leafs["destination-wild-card-bits"] = types.YLeaf{"DestinationWildCardBits", aclSequenceNumber.DestinationWildCardBits}
    aclSequenceNumber.EntityData.Leafs["ether-type-number"] = types.YLeaf{"EtherTypeNumber", aclSequenceNumber.EtherTypeNumber}
    aclSequenceNumber.EntityData.Leafs["vlan1"] = types.YLeaf{"Vlan1", aclSequenceNumber.Vlan1}
    aclSequenceNumber.EntityData.Leafs["vlan2"] = types.YLeaf{"Vlan2", aclSequenceNumber.Vlan2}
    aclSequenceNumber.EntityData.Leafs["cos"] = types.YLeaf{"Cos", aclSequenceNumber.Cos}
    aclSequenceNumber.EntityData.Leafs["dei"] = types.YLeaf{"Dei", aclSequenceNumber.Dei}
    aclSequenceNumber.EntityData.Leafs["inner-header-vlan1"] = types.YLeaf{"InnerHeaderVlan1", aclSequenceNumber.InnerHeaderVlan1}
    aclSequenceNumber.EntityData.Leafs["inner-header-vlan2"] = types.YLeaf{"InnerHeaderVlan2", aclSequenceNumber.InnerHeaderVlan2}
    aclSequenceNumber.EntityData.Leafs["inner-header-cos"] = types.YLeaf{"InnerHeaderCos", aclSequenceNumber.InnerHeaderCos}
    aclSequenceNumber.EntityData.Leafs["inner-header-dei"] = types.YLeaf{"InnerHeaderDei", aclSequenceNumber.InnerHeaderDei}
    aclSequenceNumber.EntityData.Leafs["capture"] = types.YLeaf{"Capture", aclSequenceNumber.Capture}
    aclSequenceNumber.EntityData.Leafs["log-option"] = types.YLeaf{"LogOption", aclSequenceNumber.LogOption}
    aclSequenceNumber.EntityData.Leafs["remark"] = types.YLeaf{"Remark", aclSequenceNumber.Remark}
    aclSequenceNumber.EntityData.Leafs["acl-name"] = types.YLeaf{"AclName", aclSequenceNumber.AclName}
    aclSequenceNumber.EntityData.Leafs["sequence-string"] = types.YLeaf{"SequenceString", aclSequenceNumber.SequenceString}
...
func (oorAcls *EsAcl_Active_OorAcls) GetEntityData() *types.CommonEntityData {
    ...
    oorAcls.EntityData.Children = make(map[string]types.YChild)
    oorAcls.EntityData.Children["oor-acl"] = types.YChild{"OorAcl", nil}
    for i := range oorAcls.OorAcl {
        oorAcls.EntityData.Children[types.GetSegmentPath(&oorAcls.OorAcl[i])] = types.YChild{"OorAcl", &oorAcls.OorAcl[i]}
    }
    oorAcls.EntityData.Leafs = make(map[string]types.YLeaf)
...
func (oorAcl *EsAcl_Active_OorAcls_OorAcl) GetEntityData() *types.CommonEntityData {
    ...
    oorAcl.EntityData.SegmentPath = "oor-acl" + "[name='" + fmt.Sprintf("%v", oorAcl.Name) + "']"
    ...
    oorAcl.EntityData.Children = make(map[string]types.YChild)
    oorAcl.EntityData.Leafs = make(map[string]types.YLeaf)
    oorAcl.EntityData.Leafs["name"] = types.YLeaf{"Name", oorAcl.Name}
    oorAcl.EntityData.Leafs["current-configured-ac-ls"] = types.YLeaf{"CurrentConfiguredAcLs", oorAcl.CurrentConfiguredAcLs}
    oorAcl.EntityData.Leafs["current-configured-ac-es"] = types.YLeaf{"CurrentConfiguredAcEs", oorAcl.CurrentConfiguredAcEs}
    oorAcl.EntityData.Leafs["maximum-configurable-ac-ls"] = types.YLeaf{"MaximumConfigurableAcLs", oorAcl.MaximumConfigurableAcLs}
    oorAcl.EntityData.Leafs["maximum-configurable-ac-es"] = types.YLeaf{"MaximumConfigurableAcEs", oorAcl.MaximumConfigurableAcEs}
...
func (usage *EsAcl_Active_Usages_Usage) GetEntityData() *types.CommonEntityData {
    ...
    usage.EntityData.Leafs["location"] = types.YLeaf{"Location", usage.Location}
    usage.EntityData.Leafs["application-id"] = types.YLeaf{"ApplicationId", usage.ApplicationId}
    usage.EntityData.Leafs["name"] = types.YLeaf{"Name", usage.Name}
