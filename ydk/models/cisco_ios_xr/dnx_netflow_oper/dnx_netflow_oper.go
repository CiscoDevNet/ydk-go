...
func (statistics *NetFlow_Statistics_Statistic_Producer_Statistics) GetEntityData() *types.CommonEntityData {
    ...
    statistics.EntityData.Leafs.Append("ipfix315-ingress-flows", types.YLeaf{"Ipfix315IngressFlows", statistics.Ipfix315IngressFlows})
    statistics.EntityData.Leafs.Append("ipfix315-egress-flows", types.YLeaf{"Ipfix315EgressFlows", statistics.Ipfix315EgressFlows})
