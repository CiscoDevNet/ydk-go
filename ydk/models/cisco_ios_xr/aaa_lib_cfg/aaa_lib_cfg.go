...
type Aaa_Usernames_Username struct {
    ...
    // Specify the directory for the user. The type is string with length: 1..512.
    Directory interface{}

    // Specify the shell-type for the user. The type is string with length: 1..32.
    ShellType interface{}
...
func (username *Aaa_Usernames_Username) GetEntityData() *types.CommonEntityData {
    ...
    username.EntityData.Leafs.Append("directory", types.YLeaf{"Directory", username.Directory})
    username.EntityData.Leafs.Append("shell-type", types.YLeaf{"ShellType", username.ShellType})
...
type Aaa_Diameter_Gy struct {
    ...
    // Enable or disable gy. The type is bool. The default value is true.
    Enable interface{}
    ...
    // Service Context ID in FQDN format. The type is string.
    ServiceContextId interface{}
}
...
func (gy *Aaa_Diameter_Gy) GetEntityData() *types.CommonEntityData {
    ...
    gy.EntityData.Leafs.Append("enable", types.YLeaf{"Enable", gy.Enable})
    ...
    gy.EntityData.Leafs.Append("service-context-id", types.YLeaf{"ServiceContextId", gy.ServiceContextId})
...
type Aaa_Diameter_Gx struct {
    ...
    // Enable or disable gx. The type is bool. The default value is true.
    Enable interface{}
...
func (gx *Aaa_Diameter_Gx) GetEntityData() *types.CommonEntityData {
    ...
    gx.EntityData.Leafs.Append("enable", types.YLeaf{"Enable", gx.Enable})
