...
func (lldpSnoopData *LldpSnoopData) GetEntityData() *types.CommonEntityData {
    ...
    lldpSnoopData.EntityData.Children = types.NewOrderedMap()
    lldpSnoopData.EntityData.Children.Append("ethernet-controller-names", types.YChild{"EthernetControllerNames", &lldpSnoopData.EthernetControllerNames})
    lldpSnoopData.EntityData.Leafs = types.NewOrderedMap()

    lldpSnoopData.EntityData.YListKeys = []string {}
...
func (ethernetControllerNames *LldpSnoopData_EthernetControllerNames) GetEntityData() *types.CommonEntityData {
    ...
    ethernetControllerNames.EntityData.Children = types.NewOrderedMap()
    ethernetControllerNames.EntityData.Children.Append("ethernet-controller-name", types.YChild{"EthernetControllerName", nil})
    for i := range ethernetControllerNames.EthernetControllerName {
        ethernetControllerNames.EntityData.Children.Append(types.GetSegmentPath(ethernetControllerNames.EthernetControllerName[i]), types.YChild{"EthernetControllerName", ethernetControllerNames.EthernetControllerName[i]})
    }
    ethernetControllerNames.EntityData.Leafs = types.NewOrderedMap()

    ethernetControllerNames.EntityData.YListKeys = []string {}
...
func (ethernetControllerName *LldpSnoopData_EthernetControllerNames_EthernetControllerName) GetEntityData() *types.CommonEntityData {
    ...
    ethernetControllerName.EntityData.Children = types.NewOrderedMap()
    ethernetControllerName.EntityData.Children.Append("network-addresses", types.YChild{"NetworkAddresses", &ethernetControllerName.NetworkAddresses})
    ethernetControllerName.EntityData.Leafs = types.NewOrderedMap()
    ethernetControllerName.EntityData.Leafs.Append("name", types.YLeaf{"Name", ethernetControllerName.Name})
    ethernetControllerName.EntityData.Leafs.Append("source-mac", types.YLeaf{"SourceMac", ethernetControllerName.SourceMac})
    ethernetControllerName.EntityData.Leafs.Append("chassis-id", types.YLeaf{"ChassisId", ethernetControllerName.ChassisId})
    ethernetControllerName.EntityData.Leafs.Append("port-id-detail", types.YLeaf{"PortIdDetail", ethernetControllerName.PortIdDetail})
    ethernetControllerName.EntityData.Leafs.Append("hold-time", types.YLeaf{"HoldTime", ethernetControllerName.HoldTime})
    ethernetControllerName.EntityData.Leafs.Append("port-description", types.YLeaf{"PortDescription", ethernetControllerName.PortDescription})
    ethernetControllerName.EntityData.Leafs.Append("system-name", types.YLeaf{"SystemName", ethernetControllerName.SystemName})
    ethernetControllerName.EntityData.Leafs.Append("system-description", types.YLeaf{"SystemDescription", ethernetControllerName.SystemDescription})
    ethernetControllerName.EntityData.Leafs.Append("system-capabilities", types.YLeaf{"SystemCapabilities", ethernetControllerName.SystemCapabilities})
    ethernetControllerName.EntityData.Leafs.Append("enabled-capabilities", types.YLeaf{"EnabledCapabilities", ethernetControllerName.EnabledCapabilities})
    ethernetControllerName.EntityData.Leafs.Append("lldp-neighbor", types.YLeaf{"LldpNeighbor", ethernetControllerName.LldpNeighbor})
    ethernetControllerName.EntityData.Leafs.Append("drop-enabled", types.YLeaf{"DropEnabled", ethernetControllerName.DropEnabled})
    ethernetControllerName.EntityData.Leafs.Append("rx-lldp-pkts", types.YLeaf{"RxLldpPkts", ethernetControllerName.RxLldpPkts})

    ethernetControllerName.EntityData.YListKeys = []string {"Name"}
