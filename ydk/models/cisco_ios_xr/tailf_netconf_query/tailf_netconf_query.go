...
func (startQuery *StartQuery) GetEntityData() *types.CommonEntityData {
    ...
    startQuery.EntityData.BundleName = "cisco_ios_xr"
    ...
    startQuery.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    startQuery.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    startQuery.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (fetchQueryResult *FetchQueryResult) GetEntityData() *types.CommonEntityData {
    ...
    fetchQueryResult.EntityData.BundleName = "cisco_ios_xr"
    ...
    fetchQueryResult.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    fetchQueryResult.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    fetchQueryResult.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (queryResult *FetchQueryResult_Output_QueryResult) GetEntityData() *types.CommonEntityData {
    ...
    queryResult.EntityData.BundleName = "cisco_ios_xr"
    ...
    queryResult.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    queryResult.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    queryResult.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (immediateQuery *ImmediateQuery) GetEntityData() *types.CommonEntityData {
    ...
    immediateQuery.EntityData.BundleName = "cisco_ios_xr"
    ...
    immediateQuery.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    immediateQuery.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    immediateQuery.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (resetQuery *ResetQuery) GetEntityData() *types.CommonEntityData {
    ...
    resetQuery.EntityData.BundleName = "cisco_ios_xr"
    ...
    resetQuery.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    resetQuery.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    resetQuery.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
...
func (stopQuery *StopQuery) GetEntityData() *types.CommonEntityData {
    ...
    stopQuery.EntityData.BundleName = "cisco_ios_xr"
    ...
    stopQuery.EntityData.CapabilitiesTable = cisco_ios_xr.GetCapabilities()
    stopQuery.EntityData.NamespaceTable = cisco_ios_xr.GetNamespaces()
    stopQuery.EntityData.BundleYangModelsLocation = cisco_ios_xr.GetModelsPath()
