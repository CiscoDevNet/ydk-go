...
func configIsis(isis *isisCfg.Isis) {
	...
	net.NetName = "49.0000.1720.1625.5101.00"
	...
	af.AfData.Propagations = isisCfg.Isis_Instances_Instance_Afs_Af_AfData_Propagations {
		Propagation: make(
			[]isisCfg.Isis_Instances_Instance_Afs_Af_AfData_Propagations_Propagation, 1) }
	propagation := af.AfData.Propagations.Propagation[0]
	propagation.SourceLevel = isisDatatypes.IsisInternalLevel_level2
	propagation.DestinationLevel = isisDatatypes.IsisInternalLevel_level1
	propagation.RoutePolicyName = "LOOPBACKS"

	// segment routing
	mpls := isisCfg.IsisLabelPreference_ldp
	af.AfData.SegmentRouting.Mpls = mpls
	af.AfData.SegmentRouting.PrefixSidMap.Receive = true
	af.AfData.SegmentRouting.PrefixSidMap.AdvertiseLocal = types.Empty{}
