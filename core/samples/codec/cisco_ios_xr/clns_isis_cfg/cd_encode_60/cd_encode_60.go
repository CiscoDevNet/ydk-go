...
func configIsis(isis *isisCfg.Isis) {
	...
	// todo: Level is type Isis_Instances_Instance_Afs_Af_AfData_Mpls_Level
	af.AfData.Mpls.Level.Level1 = true
	af.AfData.Mpls.Level.Level2 = true
	af.AfData.Mpls.RouterId.InterfaceName = "Loopback0"
