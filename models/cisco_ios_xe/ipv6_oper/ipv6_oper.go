...
func (ipv6Data *Ipv6Data) GetEntityData() *types.CommonEntityData {
    ...
    ipv6Data.EntityData.Children.Append("nd6-info", types.YChild{"Nd6Info", nil})
    for i := range ipv6Data.Nd6Info {
        ipv6Data.EntityData.Children.Append(types.GetSegmentPath(ipv6Data.Nd6Info[i]), types.YChild{"Nd6Info", ipv6Data.Nd6Info[i]})
    }
...
func (nd6Info *Ipv6Data_Nd6Info) GetEntityData() *types.CommonEntityData {
    ...
    nd6Info.EntityData.Children = types.NewOrderedMap()
    nd6Info.EntityData.Leafs = types.NewOrderedMap()
    nd6Info.EntityData.Leafs.Append("vrf-name", types.YLeaf{"VrfName", nd6Info.VrfName})
    nd6Info.EntityData.Leafs.Append("if-name", types.YLeaf{"IfName", nd6Info.IfName})
    nd6Info.EntityData.Leafs.Append("ip", types.YLeaf{"Ip", nd6Info.Ip})
    nd6Info.EntityData.Leafs.Append("mac-address", types.YLeaf{"MacAddress", nd6Info.MacAddress})
    nd6Info.EntityData.Leafs.Append("state", types.YLeaf{"State", nd6Info.State})
    nd6Info.EntityData.Leafs.Append("idle-timer", types.YLeaf{"IdleTimer", nd6Info.IdleTimer})
    nd6Info.EntityData.Leafs.Append("uptime", types.YLeaf{"Uptime", nd6Info.Uptime})

    nd6Info.EntityData.YListKeys = []string {"VrfName", "IfName", "Ip"}
